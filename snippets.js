[
  // CUSTOM
  { trigger: "Schrodinger", replacement: "Schrödinger", options: "tA" },
  ...
  {
    trigger: "Norm",
    replacement: "\\left\\lVert{$0}\\rVert\\right$1",
    options: "mA",
    priority: 1,
  },
  {
    trigger: "bp",
    replacement: "\\Big($0\\Big)$1",
    options: "m",
  },
  ...
  { trigger: "rt", replacement: "\\sqrt{$0}$1", options: "mA" },
  ...
  { trigger: "Re", replacement: "\\mathrm{Re}\\Big[$0\\Big]", options: "mA" },
  { trigger: "Im", replacement: "\\mathrm{Im}\\Big[$0\\Big]", options: "mA" },
  ...
  {
    trigger: "FF",
    replacement: "\\mathcal{F}",
    options: "mA",
  },
  {
    trigger: "iLL",
    replacement: "\\mathcal{L}^{-1}\\big\\{$0\\big\\}$1",
    options: "mA",
  },
  ...
  },
  {
    ...
    replacement: "\\hat{\\boldsymbol{\\[[0]]}}$1",
    options: "rmA",
  },
  {
  ...
  { trigger: "ddt", replacement: "\\frac{d$0}{dt}$1", options: "m" },
  ...
  { trigger: "sand", replacement: "\\bra{$0} $1 \\ket{$2} $3", options: "mA" },
  {
    trigger: "PP",
    replacement: "\\mathcal{P}",
    options: "mA",
  },
  {
    trigger: ".=",
  ...
  {
    trigger: "norm",
    replacement: "\\left\\lvert{$0}\\right\\rvert",
    options: "mA",
    priority: 1,
  },
